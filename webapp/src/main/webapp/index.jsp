...
<p> <pre>    a. Check for existing docker images </p>
<p> <pre>    b. Delete existing docker image and container for cases where pre-existing images and container exists</p> 
<p> <pre>    c. Docker Image is created using Ansible Playbook post pre-check </p>
<p> <pre>    d. Docker Container is deployed using the Docker Image created in step-c </p> 
